...
ButtonEncoder::ButtonEncoder(int CHA, int CHB, int BUT)
{
	chaPin = new DigitalInput(CHA);
	chbPin = new DigitalInput(CHB);
	butPin = new Button(BUT, true);
...
boolean ButtonEncoder::getValue()
{
...
void ButtonEncoder::buttonPressed()
{
	Serial.println("button pressed");
}

void ButtonEncoder::buttonReleased()
{
	Serial.println("button released");
}

void ButtonEncoder::clockwiseTurn()
{
	Serial.println("clockwise turn");
}

void ButtonEncoder::counterClockwiseTurn()
{
